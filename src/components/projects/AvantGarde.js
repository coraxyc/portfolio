  ...
  <div className="big-layout">
    ...
    <div className="layout">
      ...
      <div className="project-content">
        ...
        <img className="project-image-full" src={AGOverviewInfo} />
        <h2>The Problem</h2>
        <p>
        ...
        <img className="project-image-full" src={AGIdeationSketches}/>
        <h2>Prototyping</h2>
        <p>
        ...
        <div className="row">
          <div className="column-2">
            <h3>Prototype A</h3>
            <img className="project-image-full" src={AGPrototypeA}/>
            <p>
          ...
          <div className="column-2">
            <h3>Prototype B</h3>
            <img className="project-image-full" src={AGPrototypeB}/>
            <p>
        ...
        <img className="project-image-full" src={AGUserTesting1} />
        ...
        <img className="project-image-full" src={AGUserTesting2} />
        ...
        <img className="project-image-half" src={AGFinalProduct}/>
      </div>
    </div>
  </div>
)
